...
double probability[8][8] = { 0   ,1.15,1   ,1.1 ,1.1 ,1   ,1.15,0   ,
							   1.15,0.85,0.95,0.95,0.95,0.95,0.85,1.15,
							   1   ,0.95,1   ,1   ,1   ,1   ,0.95,1   ,
							   1.1 ,0.95,1   ,1   ,1   ,1   ,0.95,1.1   ,
							   1.1 ,0.95,1   ,1   ,1   ,1   ,0.95,1.1   ,
							   1   ,0.95,1   ,1   ,1   ,1   ,0.95,1   ,
							   1.15,0.85,0.95,0.95,0.95,0.95,0.85,1.15,
							   0   ,1.15,1   ,1.1 ,1.1 ,1   ,1.15,0 };

// best +1.1 : 1.05 : 0.95 : 0.85
double probability1[8][8] = { 0   ,1.10,1   ,1.05 ,1.05 ,1   ,1.10,0   ,
...
// 1.2 : 1.1 : 0.9 : 0.8
double probability2[8][8] = {	   0   ,1.2,1   ,1.1 ,1.1 ,1   ,1.2,0   ,
